...
class OpportunityController {
   async get(req, res){
        try {
            ...
            const response = await axios.get(`${samConfig.OPP_API}?api_key=${appConfig.SAM_API_KEY}&postedFrom=${from}&postedTo=${to}&limit=${limit}`)
            const result = await generative.sendPrompt(response.data)
